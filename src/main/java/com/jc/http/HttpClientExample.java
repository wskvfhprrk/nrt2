...
public class HttpClientExample {
    public static void main(String[] args) {
        ...
        head.setNonce(RandomStringGenerator.generateRandomString());
        head.setTimestamp(TimeBasedNumberGenerator.generateTimeBasedNumber());
...
//            String publicKey = "";
            ...
            System.out.println("签名数据是==="+content);
